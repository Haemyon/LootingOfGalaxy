	...
	if (MainWidgetObject != nullptr)
	{
		...
		if (MainWidget != nullptr)
		{
			...
			if (player != nullptr)
			{
				...
				player->OnChangedHP.AddDynamic(MainWidget, &UMainWidget::UpdateHPPercent);
				player->OnChangedSP.AddDynamic(MainWidget, &UMainWidget::UpdateSPPercent);
				player->OnChangedMP.AddDynamic(MainWidget, &UMainWidget::UpdateMPPercent);
